        ...
        <div className="mt-12 w-[90vw] mx-auto ">
            <div className="mx-auto max-w-screen-3xl px-4 lg:px-2.5">
                <div className="mx-auto max-w-5xl">
                    ...
                    <p className="text-[5vw] body-l mx-auto mb-8 w-full max-w-prose text-balance text-center md:mb-18 text-black lg:text-[1.2vw]">
                        Find out how Sierra can help your company transform the
                        customer experience with our conversational AI agents.
                    </p>
...
const FooterPart = () => {
    return (
        <footer className="mt-20 bord ">
            <div className="h-full mx-auto  lg:px-2.5 flex flex-col justify-between gap-6 md:gap-[198px] lg:gap-[293px]  ">
                <div className="grid grid-cols-12 gap-2 md:gap-2.5 pt-6 lg:pt-14">
                    <div className="col-span-12 hidden md:col-span-3 md:block lg:col-start-2">
                        <a
                            aria-label="Homepage"
                            className="flex items-center text-green-500 outline-none transition-[color] focus-visible:text-yellow active:text-green-300 theme-tech:text-white theme-tech:focus-visible:text-yellow md:pl-2 lg:pl-0"
                            href="/"
                        >
                            <svg
                                viewBox="0 0 59 67"
                    ...
                    <div className="col-span-12 grid grid-cols-subgrid gap-y-8 md:col-span-9 md:gap-y-18 lg:col-span-8">
                        ...
                        <div className="col-span-6 flex flex-col gap-4 md:col-span-3 lg:col-span-2">
                            <h3 className="font-medium text-gray-600 theme-tech:text-gray-100">
                                Customers
                            </h3>
                            <ul className="flex flex-col gap-4">
                                <li className="body-s">
                ...
                <div className="grid grid-cols-12 gap-2 md:gap-2.5">
                    <div className="body-s col-span-12 mb-6 text-gray-300 theme-tech:text-gray-100 text-left flex justify-center items-center">
                        <span>© 2024 Sierra</span>
                    </div>
                </div>
            </div>
        </footer>
